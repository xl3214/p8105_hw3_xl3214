...
- Based on the plots, we can see that *Poor* responses correspond to the
  lowest crude prevalence across all locations in NY State for both 2006
  and 2010, and as the order of responses increases towards *Very good*,
  the crude prevalence also increases. However, for responses of
