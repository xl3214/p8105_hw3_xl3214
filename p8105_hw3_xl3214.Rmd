...
aisle_for_table <- instacart |>
  ...
  summarize(n_obs = n()) |>
  filter(n_obs %in% tail(sort(unique(n_obs)), 3)) 
aisle_for_table
```
...
aisle_for_table_2 <- instacart |>
  ...
  unique(aisle_for_table_2$order_dow, incomparables = FALSE)

aisle_for_table_2 <- arrange(aisle_for_table_2, order_dow)
aisle_for_table_2 <-
  pivot_wider(
    aisle_for_table_2,
  ...
  unique(aisle_for_table_2, order_dow)
aisle_for_table_2
```
